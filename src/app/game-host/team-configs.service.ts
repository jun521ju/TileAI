...
import { minimaxScript } from '../game/ai/minimax.ai';
import { dfsScript } from '../game/ai/dfs.ai';
...
export class TeamConfigsService {
  ...
  parseTeamConfigs(): Observable<ITeamConfig[]> {
    this.teamConfigs.push(this.dfsConfig);
    this.teamConfigs.push(this.developmentConfig);
    this.teamConfigs.push(this.minimaxConfig);
    const self = this;
